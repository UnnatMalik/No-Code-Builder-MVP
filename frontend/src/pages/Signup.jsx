...
const Signup = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4 sm:p-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-secondary/20 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-[28rem] relative z-10">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-[2rem] p-10 shadow-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 text-sm">Join us and start building an amazing workspace.</p>
