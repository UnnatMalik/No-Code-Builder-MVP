    ...
    <div className="flex h-screen w-full overflow-hidden bg-surface text-on-surface absolute top-0 left-0 z-50 antialiased">
      ...
      <aside className="hidden md:flex flex-col h-full w-64 bg-surface/80 backdrop-blur-[20px] border-r border-slate-200/50 p-4 z-50 fixed left-0 top-0">
        ...
        <nav className="space-y-1 mb-auto">
          <Link to="/dashboard" className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:text-indigo-500 font-['Plus_Jakarta_Sans'] text-sm font-medium transition-transform duration-200 hover:translate-x-1">
            <span className="material-symbols-outlined">dashboard</span>
            <span>Dashboard</span>
          </Link>
          <Link to="/projects" className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 shadow-sm rounded-lg font-['Plus_Jakarta_Sans'] text-sm font-medium transition-transform duration-200 hover:translate-x-1">
            <span className="material-symbols-outlined">folder</span>
            <span>My Projects</span>
          </Link>
          <Link to="#" className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:text-indigo-500 font-['Plus_Jakarta_Sans'] text-sm font-medium transition-transform duration-200 hover:translate-x-1">
