...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (email === 'admin@example.com' && password === 'admin123') {
      ...
      setError('Invalid email or password. (Hint: admin@example.com / admin123)');
    }
  };
      ...
      <div className="w-full max-w-[28rem] relative z-10">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-[2rem] p-10 shadow-2xl">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-headline font-extrabold text-slate-900 mb-3">Welcome Back</h1>
          ...
          <div className="mt-8 text-center text-sm text-on-surface-variant font-medium">
            ...
            <Link to="/" className="text-primary hover:text-secondary font-bold transition-colors">
