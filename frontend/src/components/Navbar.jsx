      ...
      <div className="flex justify-between items-center h-20 px-8 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center space-x-8 font-headline font-semibold text-sm">
          ...
          {!isAuthenticated ? (
            ...
            <>
              <Link to="/dashboard" className="text-slate-600 hover:text-primary transition-colors duration-200">Dashboard</Link>
              <button
                onClick={handleLogout}
                className="inline-block bg-gradient-to-r from-primary to-secondary text-on-primary px-6 py-2.5 rounded-full font-bold shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-200"
              >
                Logout
              </button>
            </>
