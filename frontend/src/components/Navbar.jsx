        ...
        <div className="hidden md:flex items-center space-x-8 font-headline font-semibold text-sm">
          ...
          {!isAuthenticated ? (
            <>
              ...
              <Link to="/register" className="bg-gradient-to-r from-primary to-secondary text-on-primary px-6 py-2.5 rounded-full font-bold hover:scale-[1.02] active:scale-[0.98] transition-transform">
                Get Started Free
              </Link>
            </>
          ) : (
            <>
              ...
              <button
                ...
                className="bg-gradient-to-r from-primary to-secondary text-on-primary px-6 py-2.5 rounded-full font-bold hover:scale-[1.02] active:scale-[0.98] transition-transform"
              >
                Logout
              </button>
            </>
